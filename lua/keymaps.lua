...
wk.register({
  ...
  ['[f']         = { ':lua require("neotest").jump.prev({ status = "failed" })<CR>', "Jump to Previous Failed Test" },
  [']f']         = { ':lua require("neotest").jump.next({ status = "failed" })<CR>', "Jump to Next Failed Test" },
})
...
wk.register({
  ...
  ['<leader>ep'] = { [[:lua require("finders").projects()<CR>]], "Projects" },
