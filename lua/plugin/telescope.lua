...
map('n', '<leader>j', [[<cmd>Telescope jumplist<CR>]], { noremap = true })
map('n', '<leader>l', [[<cmd>Telescope loclist<CR>]], { noremap = true })
map('n', '<leader>m', [[<cmd>Telescope marks<CR>]], { noremap = true })
map('n', '<leader>q', [[<cmd>Telescope quickfix<CR>]], { noremap = true })
